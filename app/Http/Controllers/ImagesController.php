...
class ImagesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $imageManager = $this->imageManager->make(storage_path('app/'.$image->name));
        ...
        // Get the image with the spevified brightness
    ...
    {   
        ...
        return response()->download(storage_path('app/'.$image->name), $image->original_name);
    }
    ...
    public function store()
    {
        ...
        $this->request->file('file')->move(
            storage_path('app'), $image->id.'.'.$this->request->file('file')->guessExtension()
        );
    ...
    public function resize($id)
    {
        ...
        return $this->imageManager->make(storage_path('app/'.$image->name))
    ...
    public function encode($id)
    {
        ...
        $this->filesystem->delete(storage_path('app/'.$image->name));
        ...
        return $imageManager->save(
            storage_path('app/'.$image->id.'.'.$this->getExtension($imageManager))
        )->response();
    }
    ...
    /**
     * Get the extension for an image.
     *
     * @param  \Intervention\Image\Image  $imageManager
     * @return string
     */
    ...
    public function destroy($id)
    {
        ...
        if ($this->filesystem->delete(storage_path('app/'.$image->name))) {
            $image->delete();
